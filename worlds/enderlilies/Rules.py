...
def get_rules(p : int) -> Tuple[Dict[str, CollectionRule], Dict[str, ItemRule]]: 
	...
	locations_rules : Dict[str, CollectionRule] = {
		"The Abyss 01 - Silva's Blight-Stained Note 1"         : lambda s : True,
		"The Abyss 01 - Furious Blight x100"                   : lambda s : True,
		"The Abyss 01 To Verboten Domain 18"                   : lambda s : True,
		"The Abyss 01 To The Abyss 02"                         : lambda s : True,
		"The Abyss 01 Top To Bottom"                           : lambda s : macros['CHARGE'](s) and s.has(el['slam'], p) and s.has(el['swim'], p) and (macros['2HORIZONTAL'](s) and macros['LEDGE'](s) or macros['FULLSILVA'](s) or macros['3LEDGE'](s) or s.has(el['silva'], p) and (s.has(el['dodge'], p) or s.has(el['djump'], p)) or s.has(el['champion'], p) and s.has(el['djump'], p) or s.has(el['claw'], p) and macros['HORIZONTAL'](s) and macros['LEDGE'](s)) and (s.has(el['hook'], p) or macros['FULLSILVA'](s) or macros['3LEDGE'](s) or macros['2HORIZONTAL'](s) and macros['LEDGE'](s)),
		"The Abyss 02 - Amulet Fragment"                       : lambda s : s.has(el['claw'], p) and (macros['2LEDGE'](s) or macros['2LEDGE'](s) and macros['HORIZONTAL'](s) or macros['2HORIZONTAL'](s) and macros['LEDGE'](s) or s.has(el['dodge'], p) and s.has(el['dash'], p) and macros['LEDGE'](s)),
		"The Abyss 02 - Silva's Blight-Stained Note 2"         : lambda s : True,
		"The Abyss 02 - Fretia's Memoirs 5"                    : lambda s : True,
		"The Abyss 02 - White Priestess' Earrings"             : lambda s : True,
		"The Abyss 02 To The Abyss 03"                         : lambda s : True,
		"The Abyss 02 To The Abyss 01"                         : lambda s : True,
		"The Abyss 03 To The Abyss 02"                         : lambda s : True,
		"The Abyss 04 - Upper Stagnant Blight x100"            : lambda s : s.has(el['mask'], p) and s.has(el['slam'], p) and s.has(el['claw'], p) and s.has(el['hook'], p) and macros['3HEAL'](s) and s.has(el['dash'], p),
		"The Abyss 04 - Lower Stagnant Blight x100"            : lambda s : s.has(el['mask'], p) and macros['3HEAL'](s),
		"The Abyss 04 Top To Bottom"                           : lambda s : s.has(el['mask'], p) and s.has(el['swim'], p) and s.has(el['slam'], p) and s.has(el['claw'], p) and s.has(el['hook'], p) and macros['3HEAL'](s) and s.has(el['dash'], p),
		"The Abyss 04 To Verboten Domain 12"                   : lambda s : True,
		"The Abyss 04 To The Abyss 05"                         : lambda s : True,
		"The Abyss 05 - Stone Tablet Fragment"                 : lambda s : s.has(el['swim'], p),
		"The Abyss 05 - The Deathless Pact"                    : lambda s : s.has(el['swim'], p),
		"The Abyss 05 To Verboten Domain 12"                   : lambda s : s.has(el['swim'], p),
		"The Abyss 05 - Ancient Soul x2"                       : lambda s : s.has(el['swim'], p),
		"The Abyss 05 To The Abyss 04"                         : lambda s : True,
		"Ruined Castle 01 - Castle Town Maiden"                : lambda s : True,
		"Ruined Castle 01 - Priestess' Doll"                   : lambda s : macros['LEDGE'](s) or macros['HORIZONTAL'](s),
		"Ruined Castle 01 - Decayed Crown"                     : lambda s : True,
		"Ruined Castle 01 - Stagnant Blight x100"              : lambda s : macros['CHARGE'](s),
		"Ruined Castle 01 - Furious Blight x100"               : lambda s : macros['CHARGE'](s),
		"Ruined Castle 01 To Cliffside Hamlet 11"              : lambda s : True,
		"Ruined Castle 01 To Ruined Castle 02 Lower"           : lambda s : True,
		"Ruined Castle 01 To Ruined Castle 02 Upper"           : lambda s : True,
		"Ruined Castle 01 To Ruined Castle 10"                 : lambda s : s.has(el['claw'], p),
		"Ruined Castle 01 Left To Right"                       : lambda s : macros['LEDGE'](s) or macros['HORIZONTAL'](s) or s.has(el['dash'], p) or s.has(el['claw'], p),
		"Ruined Castle 01 Right To Left"                       : lambda s : True,
		"Ruined Castle 01 Top To Bottom"                       : lambda s : True,
		"Ruined Castle 02 - Amulet Fragment"                   : lambda s : macros['LEDGE'](s) or macros['HORIZONTAL'](s) or s.has(el['dash'], p) or s.has(el['claw'], p) or s.has(el['hook'], p),
		"Ruined Castle 02 To Ruined Castle 05"                 : lambda s : True,
		"Ruined Castle 02 - Stagnant Blight x30"               : lambda s : s.has(el['hook'], p),
		"Ruined Castle 02 To Ruined Castle 01 Lower"           : lambda s : True,
		"Ruined Castle 02 Top To Bottom"                       : lambda s : True,
		"Ruined Castle 02 Bottom To Top"                       : lambda s : macros['LEDGE'](s) or s.has(el['claw'], p) or s.has(el['hook'], p),
		"Ruined Castle 02 To Ruined Castle 04"                 : lambda s : True,
		"Ruined Castle 02 To Ruined Castle 01 Upper"           : lambda s : s.has(el['claw'], p) and macros['LEDGE'](s),
		"Ruined Castle 03 - Amulet Fragment"                   : lambda s : s.has(el['hook'], p) or s.has(el['claw'], p) or macros['HORIZONTAL'](s) or s.has(el['dash'], p) or macros['LEDGE'](s),
		"Ruined Castle 03 - Stagnant Blight x30"               : lambda s : s.has(el['hook'], p) or s.has(el['claw'], p) or macros['LEDGE'](s) and macros['HORIZONTAL'](s),
		"Ruined Castle 03 To Ruined Castle 05"                 : lambda s : True,
		"Ruined Castle 03 To Ruined Castle 11 Left"            : lambda s : macros['FULLSILVA'](s) and s.has(el['champion'], p) and s.has(el['claw'], p),
		"Ruined Castle 03 To Ruined Castle 11 Right"           : lambda s : macros['FULLSILVA'](s) and s.has(el['champion'], p) and s.has(el['claw'], p),
		"Ruined Castle 03 Top To Bottom"                       : lambda s : True,
		"Ruined Castle 04 - Report from a Verboten Mage"       : lambda s : True,
		"Ruined Castle 04 To Ruined Castle 02"                 : lambda s : macros['LEDGE'](s) or s.has(el['claw'], p) or macros['HORIZONTAL'](s),
		"Ruined Castle 05 To Ruined Castle 02"                 : lambda s : True,
		"Ruined Castle 05 To Ruined Castle 06"                 : lambda s : True,
		"Ruined Castle 05 To Ruined Castle 08"                 : lambda s : True,
		"Ruined Castle 05 To Ruined Castle 03"                 : lambda s : False,
		"Ruined Castle 06 - Royal Aegis Crest"                 : lambda s : True,
		"Ruined Castle 06 To Ruined Castle 12"                 : lambda s : True,
		"Ruined Castle 06 To Ruined Castle 07"                 : lambda s : True,
		"Ruined Castle 06 - Stagnant Blight x30"               : lambda s : s.has(el['claw'], p),
		"Ruined Castle 06 To Ruined Castle 05"                 : lambda s : True,
		"Ruined Castle 07 - Proof of Founding"                 : lambda s : True,
		"Ruined Castle 07 To Twin Spires 01"                   : lambda s : s.has(el['hook'], p) or macros['3LEDGE'](s),
		"Ruined Castle 07 To Ruined Castle 06"                 : lambda s : True,
		"Ruined Castle 08 - Chain of Sorcery"                  : lambda s : s.has(el['claw'], p) and (macros['LEDGE'](s) or macros['HORIZONTAL'](s) or s.has(el['dash'], p)),
		"Ruined Castle 08 - Blightwreathed Blade"              : lambda s : True,
		"Ruined Castle 08 - Stagnant Blight x10"               : lambda s : True,
		"Ruined Castle 08 - Upper Stagnant Blight x10"         : lambda s : True,
		"Ruined Castle 08 - Lower Stagnant Blight x10"         : lambda s : True,
		"Ruined Castle 08 To Ruined Castle 05"                 : lambda s : True,
		"Ruined Castle 08 To Ruined Castle 09"                 : lambda s : True,
		"Ruined Castle 08 Bottom To Top"                       : lambda s : s.has(el['claw'], p) or macros['LEDGE'](s) or macros['HORIZONTAL'](s) or s.has(el['dash'], p),
		"Ruined Castle 08 Top To Bottom"                       : lambda s : True,
		"Ruined Castle 09 - Furious Blight x30"                : lambda s : macros['2HORIZONTAL'](s) or s.has(el['claw'], p) and (macros['2LEDGE'](s) or macros['LEDGE'](s) and macros['HORIZONTAL'](s)) or macros['FULLSILVA'](s) or macros['LEDGE'](s) and s.has(el['sinner'], p) or s.has(el['djump'], p) and s.has(el['dash'], p) and (s.has(el['silva'], p) or s.has(el['dodge'], p)),
		"Ruined Castle 09 To Ruined Castle 11"                 : lambda s : True,
		"Ruined Castle 09 To Ruined Castle 08"                 : lambda s : True,
		"Ruined Castle 09 To Ruined Castle 10"                 : lambda s : True,
		"Ruined Castle 10 - Julius' Book"                      : lambda s : True,
		"Ruined Castle 10 - Stagnant Blight x30"               : lambda s : True,
		"Ruined Castle 10 To Ruined Castle 09"                 : lambda s : True,
		"Ruined Castle 10 To Ruined Castle 01"                 : lambda s : True,
		"Ruined Castle 11 To Ruined Castle 12"                 : lambda s : True,
		"Ruined Castle 11 To Ruined Castle 09"                 : lambda s : True,
		"Ruined Castle 11 To Ruined Castle 13"                 : lambda s : True,
		"Ruined Castle 11 To Ruined Castle 03 Left"            : lambda s : True,
		"Ruined Castle 11 To Ruined Castle 03 Right"           : lambda s : True,
		"Ruined Castle 11 Left To Top"                         : lambda s : macros['LEDGE'](s) and s.has('Ruined Castle 11 - Left Lever', p) and s.has('Ruined Castle 11 - Right Lever', p),
		"Ruined Castle 11 Right To Top"                        : lambda s : macros['LEDGE'](s) and s.has('Ruined Castle 11 - Left Lever', p) and s.has('Ruined Castle 11 - Right Lever', p),
		"Ruined Castle 11 - Left Lever"                        : lambda s : True,
		"Ruined Castle 11 - Right Lever"                       : lambda s : True,
		"Ruined Castle 12 - Chain of Sorcery"                  : lambda s : s.has(el['hook'], p) or (macros['3LEDGE'](s) and s.has(el['claw'], p) and s.has(el['dodge'], p)),
		"Ruined Castle 12 - King of the First Age's Diary 1"   : lambda s : True,
		"Ruined Castle 12 - King of the First Age's Diary 2"   : lambda s : True,
		"Ruined Castle 12 To Ruined Castle 06"                 : lambda s : True,
		"Ruined Castle 12 - Stagnant Blight x30"               : lambda s : s.has(el['hook'], p) or s.has(el['claw'], p) or macros['HORIZONTAL'](s),
		"Ruined Castle 12 To Ruined Castle 11"                 : lambda s : True,
		"Ruined Castle 12 To Ruined Castle 21"                 : lambda s : True,
		"Ruined Castle 12 Center To Right"                     : lambda s : s.has(el['unlock'], p),
        "Ruined Castle 12 Center To Left"                      : lambda s : True,
        "Ruined Castle 12 Left To Center"                      : lambda s : s.has(el['hook'], p) and (s.has(el['claw'], p) or macros['LEDGE'](s) or macros['HORIZONTAL'](s) or s.has(el['dash'], p)) or s.has(el['slam'], p or (s.has(el['claw'], p) and macros['LEDGE'](s))),
		"Ruined Castle 13 - Amulet Gem"                        : lambda s : s.has(el['silva'], p) and s.has(el['djump'], p) and s.has(el['claw'], p) or (macros['FULLSILVA'](s) or macros['3LEDGE'](s)) and s.has(el['hook'], p) or macros['2LEDGE'](s) and s.has(el['hook'], p) and s.has(el['claw'], p) or macros['LEDGE'](s) and macros['HORIZONTAL'](s) and s.has(el['claw'], p) and s.has(el['hook'], p),
		"Ruined Castle 13 To Ruined Castle 17"                 : lambda s : True,
		"Ruined Castle 13 To Ruined Castle 11"                 : lambda s : True,
		"Ruined Castle 13 To Ruined Castle 14"                 : lambda s : True,
		"Ruined Castle 14 - Amulet Fragment"                   : lambda s : s.has(el['hook'], p),
		"Ruined Castle 14 - Stagnant Blight x100"              : lambda s : macros['CHARGE'](s) and (s.has(el['claw'], p) or macros['LEDGE'](s) and macros['HORIZONTAL'](s)),
		"Ruined Castle 14 - Furious Blight x800"               : lambda s : s.has(el['claw'], p) and (macros['3LEDGE'](s) or macros['FULLSILVA'](s) or s.has(el['sinner'], p) and macros['2LEDGE'](s) or s.has(el['silva'], p) and macros['2HORIZONTAL'](s) or s.has(el['dodge'], p) and s.has(el['dash'], p) and macros['2LEDGE'](s)),
		"Ruined Castle 14 To Ruined Castle 13"                 : lambda s : True,
		"Ruined Castle 14 To Ruined Castle 15"                 : lambda s : macros['LEDGE'](s) or s.has(el['hook'], p),
		"Ruined Castle 15 - Priestess' Wish"                   : lambda s : True,
		"Ruined Castle 15 - Priestess' Castle Memo"            : lambda s : True,
		"Ruined Castle 15 To Ruined Castle 16"                 : lambda s : s.has(el['claw'], p) and (s.has(el['hook'], p) or macros['FULLSILVA'](s) and s.has(el['sinner'], p) or macros['3LEDGE'](s)),
		"Ruined Castle 15 To Ruined Castle 14"                 : lambda s : True,
        "Ruined Castle 16 - One-Eyed Royal Aegis"              : lambda s : True,
		"Ruined Castle 16 - 2nd Stagnant Blight x10"           : lambda s : True,
		"Ruined Castle 16 - 5th Stagnant Blight x10"           : lambda s : True,
		"Ruined Castle 16 - 9th Stagnant Blight x10"           : lambda s : True,
		"Ruined Castle 16 - 1st Stagnant Blight x10"           : lambda s : True,
		"Ruined Castle 16 - 8th Stagnant Blight x10"           : lambda s : True,
		"Ruined Castle 16 - 3rd Stagnant Blight x10"           : lambda s : True,
		"Ruined Castle 16 - 7th Stagnant Blight x10"           : lambda s : True,
		"Ruined Castle 16 - 6th Stagnant Blight x10"           : lambda s : True,
		"Ruined Castle 16 - 4th Stagnant Blight x10"           : lambda s : True,
		"Ruined Castle 16 - 10th Stagnant Blight x10"          : lambda s : s.has(el['claw'], p),
        "Ruined Castle 16 To Ruined Castle 18"                 : lambda s : True,
		"Ruined Castle 16 To Ruined Castle 15"                 : lambda s : True,
        "Ruined Castle 17 - Stagnant Blight x30"               : lambda s : macros['LEDGE'](s) or s.has(el['claw'], p) or macros['HORIZONTAL'](s),
		"Ruined Castle 17 To Ruined Castle 13"                 : lambda s : True,
		"Ruined Castle 17 To Ruined Castle 18"                 : lambda s : True,
        "Ruined Castle 17 To Top"                              : lambda s : macros['LEDGE'](s),
		"Ruined Castle 18 - Amulet Fragment"                   : lambda s : macros['CHARGE'](s),
		"Ruined Castle 18 - King's Note 2"                     : lambda s : macros['CHARGE'](s) and (s.has(el['claw'], p) or s.has(el['hook'], p) and macros['LEDGE'](s)),
		"Ruined Castle 18 - Eldred's Ring"                     : lambda s : macros['CHARGE'](s) and (s.has(el['claw'], p) or s.has(el['hook'], p) and macros['LEDGE'](s)),
		"Ruined Castle 18 - Furious Blight x100"               : lambda s : macros['CHARGE'](s) and s.has(el['hook'], p) and macros['LEDGE'](s),
		"Ruined Castle 18 To Ruined Castle 19"                 : lambda s : True,
		"Ruined Castle 18 To Ruined Castle 17"                 : lambda s : True,
        "Ruined Castle 18 Left To Right"                       : lambda s : s.has(el['claw'], p) or s.has(el['hook'], p) and macros['LEDGE'](s),
        "Ruined Castle 18 Right To Left"                       : lambda s : s.has(el['claw'], p) or s.has(el['hook'], p) and macros['LEDGE'](s),
		"Ruined Castle 19 - King's Note 1"                     : lambda s : True,
		"Ruined Castle 19 To Ruined Castle 20"                 : lambda s : True,
		"Ruined Castle 19 To Ruined Castle 18"                 : lambda s : True,
		"Ruined Castle 20 - Knight Captain Julius"             : lambda s : True,
		"Ruined Castle 20 To Ruined Castle 19"                 : lambda s : True,
		"Ruined Castle 21 - King of the First Age's Diary 3"   : lambda s : True,
		"Ruined Castle 21 - Stone Tablet Fragment"             : lambda s : True,
		"Ruined Castle 21 To Ruined Castle 12"                 : lambda s : True,
		"Ruined Castle 21 - Stagnant Blight x100"              : lambda s : True,
        "Catacombs 01 - Fretia's Ring"                         : lambda s : True,
		"Catacombs 01 - Furious Blight x800"                   : lambda s : True,
		"Catacombs 01 To Catacombs 02"                         : lambda s : True,
		"Catacombs 01 To Cliffside Hamlet 12"                  : lambda s : True,
		"Catacombs 01 Left To Right"                           : lambda s : macros['3LEDGE'](s) and macros['2HORIZONTAL'](s),
        "Catacombs 01 Bottom To Left"                          : lambda s : True,
        "Catacombs 01 Bottom To Right"                         : lambda s : s.has(el['claw'], p) or s.has(el['djump'], p) or s.has(el['champion'], p) or s.has(el['silva'], p) and s.has(el['dodge'], p),
        "Catacombs 02 - Stagnant Blight x30"                   : lambda s : s.has(el['hook'], p) or s.has(el['claw'], p) and (macros['HORIZONTAL'](s) or s.has(el['djump'], p) or s.has(el['champion'], p) and s.has(el['dash'], p) or s.has(el['silva'], p) and s.has(el['dash'], p)),
		"Catacombs 02 - Stagnant Blight x10"                   : lambda s : True,
		"Catacombs 02 To Catacombs 05"                         : lambda s : True,
		"Catacombs 02 To Catacombs 07"                         : lambda s : s.has(el['slam'], p),
		"Catacombs 02 To Catacombs 01"                         : lambda s : s.has(el['claw'], p) and (macros['FULLSILVA'](s) and s.has(el['dash'], p) or macros['3LEDGE'](s) or macros['2LEDGE'](s) and macros['2HORIZONTAL'](s) or s.has(el['silva'], p) and macros['2HORIZONTAL'](s) or s.has(el['silva'], p) and s.has(el['sinner'], p) and s.has(el['djump'], p) or s.has(el['dash'], p) and s.has(el['djump'], p) and s.has(el['champion'], p) and s.has(el['sinner'], p)),
		"Catacombs 03 - Defense of the Twin Spires 2"          : lambda s : True,
		...
		"Catacombs 03 To Catacombs 06"                         : lambda s : True,
        "Catacombs 03 Left To Center"                          : lambda s : True,
        "Catacombs 03 Right To Center"                         : lambda s : True,
		"Catacombs 04 - Amulet Fragment"                       : lambda s : True,
		"Catacombs 04 To Catacombs 16"                         : lambda s : True,
		"Catacombs 04 To Catacombs 05"                         : lambda s : True,
		"Catacombs 04 To Catacombs 12"                         : lambda s : True,
		"Catacombs 04 To Left"                                 : lambda s : s.has(el['unlock'], p),
		...
		"White Parish 01 To White Parish 02"                   : lambda s : True,
		"White Parish 01 To White Parish 12"                   : lambda s : True,
		"White Parish 02 - Amulet Fragment"                    : lambda s : True,
		"White Parish 02 - Eleine's Letter"                    : lambda s : True,
		"White Parish 02 To White Parish 01"                   : lambda s : True,
		"White Parish 02 To White Parish 10"                   : lambda s : True,
		"White Parish 02 Left To Right"                        : lambda s : True,
        "White Parish 02 Right To Left"                        : lambda s : s.has(el['djump'], p) or s.has(el['champion'], p) or s.has(el['silva'], p) and s.has(el['dodge'], p),
        "White Parish 03 - Guardian Siegrid"                   : lambda s : True,
		"White Parish 03 To White Parish 05"                   : lambda s : True,
		"White Parish 03 To White Parish 04"                   : lambda s : True,
		"White Parish 04 - Groa's Letter"                      : lambda s : True,
		"White Parish 04 To White Parish 03"                   : lambda s : True,
		"White Parish 04 To White Parish 06"                   : lambda s : True,
		"White Parish 05 - Soiled Prayer Beads"                : lambda s : True,
		"White Parish 05 To White Parish 11"                   : lambda s : True,
		"White Parish 05 To White Parish 03"                   : lambda s : True,
		"White Parish 05 To White Parish 09"                   : lambda s : s.has(el['claw'], p),
        "White Parish 05 Top To Bottom"                        : lambda s : True,
        "White Parish 05 Bottom To Top"                        : lambda s : macros['LEDGE'](s) or s.has(el['claw'], p),
		"White Parish 06 To White Parish 04"                   : lambda s : True,
		"White Parish 06 To White Parish 07"                   : lambda s : macros['LEDGE'](s) or s.has(el['claw'], p),
		"White Parish 07 - Cliffside Hamlet Youth"             : lambda s : True,
		"White Parish 07 - Chain of Sorcery"                   : lambda s : s.has(el['slam'], p),
		"White Parish 07 To White Parish 06"                   : lambda s : True,
		"White Parish 07 To White Parish 08"                   : lambda s : True,
		"White Parish 07 Left To Right"                        : lambda s : macros['LEDGE'](s) or s.has(el['claw'], p),
        "White Parish 07 Right To Left"                        : lambda s : macros['LEDGE'](s) or s.has(el['claw'], p),
        "White Parish 08 - Amulet Fragment"                    : lambda s : s.has(el['swim'], p),
		"White Parish 08 - The Parish Way 2"                   : lambda s : True,
		"White Parish 08 To Cliffside Hamlet 01"               : lambda s : True,
		"White Parish 08 To Witch's Thicket 01"                : lambda s : True,
		"White Parish 08 To White Parish 07"                   : lambda s : True,
		"White Parish 09 - Chief Guardian"                     : lambda s : True,
		"White Parish 09 - Vibrant Plume"                      : lambda s : macros['CHARGE'](s) and (macros['LEDGE'](s) and s.has(el['claw'], p) or macros['3LEDGE'](s)),
		"White Parish 09 - Furious Blight x30"                 : lambda s : True,
		"White Parish 09 To White Parish 05"                   : lambda s : True,
		"White Parish 09 To White Parish 01"                   : lambda s : True,
		"White Parish 09 To White Parish 14"                   : lambda s : s.has(el['hook'], p),
		"White Parish 10 - On the Blighted 1"                  : lambda s : True,
		"White Parish 10 - On the Blighted 2"                  : lambda s : True,
		"White Parish 10 To White Parish 02"                   : lambda s : True,
		"White Parish 10 To White Parish 11"                   : lambda s : True,
		"White Parish 11 - Amulet Fragment"                    : lambda s : True,
		"White Parish 11 - The Parish Way 1"                   : lambda s : True,
		"White Parish 11 To White Parish 05"                   : lambda s : True,
		"White Parish 11 To White Parish 10"                   : lambda s : True,
        "White Parish 11 To Top"                               : lambda s : True,
		"White Parish 12 - Statue Inscription"                 : lambda s : True,
		"White Parish 12 To White Parish 01"                   : lambda s : True,
		"White Parish 12 To White Parish 13"                   : lambda s : s.has(el['unlock'], p),
		"White Parish 13 - Restoring the Aegis Curio"          : lambda s : True,
		"White Parish 13 To White Parish 12"                   : lambda s : True,
		"White Parish 14 - Priestess' Wish"                    : lambda s : True,
		"White Parish 14 - Lily's Note"                        : lambda s : True,
		"White Parish 14 To White Parish 09"                   : lambda s : True,
